	...
	const imagenes = [
		{
			...
			color: "#FFC76F",
			titulo: "Bonos",
			texto: "Explora el mundo de los bonos: aprende sobre estos activos financieros y cómo pueden contribuir a tu estrategia de inversión.",
		},
		{
			src: cedears,
			color: "#E26C48",
			titulo: "Cedears",
			texto: "Conoce cómo estos valores representativos de acciones extranjeras pueden ser una alternativa interesante para diversificar tu portafolio de inversión.",
		},
		{
			src: cripto,
			color: "#F03F59",
			titulo: "Cripto",
			texto: "Explora el universo de las criptomonedas: comprende su funcionamiento y cómo pueden ofrecer nuevas oportunidades de inversión en el panorama financiero actual.",
		},
		{
			src: letras,
			color: "#44A8D2",
			titulo: "Letras",
			texto: "Conoce cómo estos instrumentos de deuda representan una forma segura y rentable de inversión, ofreciendo intereses fijos en un período determinado.",
		},
		{
			src: plazoFijo,
			color: "#76EC4D",
			titulo: "Plazo Fijo",
			texto: "Sumérgete en el mundo de los plazos fijos: conoce cómo estos productos financieros pueden ofrecer seguridad y crecimiento constante para tus ahorros.",
		},
	];
	...
	return (
		<div className="inversiones-container">
			<div
				...
				style={{ backgroundColor: imagenes[indiceActual].color }}
			>
				<div
					className="imagenes-circle"
					...
					{imagenes.map((imagen, indice) => (
						<div
							...
							className={`circle-image ${
								indice !== indiceActual ? "not-selected" : ""
							}`}
						>
							<img
								src={imagen.src}
			...
			<div className="textoInversiones-container">
				...
				<Link to="/cedears">
					<button
						className="AprenderBtn"
						style={{
							backgroundColor: imagenes[indiceActual].color,
						}}
					>
						Practicar
					</button>
			...
			<div className="eslogan-container">
				<h2 style={{ color: imagenes[indiceActual].color }}>
					Invertí fácil, hacelo en CRIOLLO
				</h2>
			</div>
