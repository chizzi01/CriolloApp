...
export default function PieActiveArc() {
  ...
  useEffect(() => {
    handleStorageChange(); // Carga inicial de datos
    ...
    // Asegúrate de llamar a handleResize al inicio para establecer el tamaño inicial
    handleResize();
  ...
  return (
    <div className="my-chart-container" style={{ width: '100%' }}>
      <PieChart
        series={[
          {
            data: series,
