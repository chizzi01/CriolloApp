					...
					>
						<Link to="/tutoriales">
							...
							>
								<p
									className={
										currentSection === "tutoriales-section"
											? "active"
											: ""
									}
								>
						...
						<Link to="/practicas">
							<Button style={{ outline: "none" }} disableRipple>
								<p
									className={
										currentSection === "practicas-section"
											? "active"
											: ""
									}
								>
						...
						<Link to="/novedades">
							<Button style={{ outline: "none" }} disableRipple>
								<p
									className={
										currentSection === "novedades-section"
											? "active"
											: ""
									}
								>
						...
						<Link to="/comunidad">
							<Button style={{ outline: "none" }} disableRipple>
								<p
									className={
										currentSection === "comunidad-section"
											? "active"
											: ""
									}
								>
					...
					<List>
						{[
							...
							},
							{
								...
								secondary:
									"Aprende conceptos básicos de finanzas y economía",
							},
							{
								primary: "Conceptos Avanzados",
								secondary:
									"Aprende conceptos avanzados de finanzas y economía",
							},
							{
								primary: "Ahorros",
								secondary:
									"Descubre cómo empezar a ahorrar de manera efectiva",
							},
							{
								primary: "Inversiones",
								secondary:
									"Explora oportunidades de inversión y aprende a hacer crecer tu dinero (Cedears, FIMA, Bonos, Cripto)",
							},
						].map((item, index) => (
